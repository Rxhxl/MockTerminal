...
public class History implements Command, Serializable {
   ...
   * 
   * @param input this is the command that gets added to the list of previous commands
   */
   ...
   * 
   * @return Returns a string that states the functionality of the history command
   */
